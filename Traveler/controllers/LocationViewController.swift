...
//        locationNameTextfield.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
//        
//        buttonLayoutAlignment(button: nextButton)
//    }
//    
//    @objc func gotoGender1(){
//        print("hello world")
////        let genderController =  GenderViewController()
////        genderController.modalPresentationStyle = .fullScreen
////        genderController.data = locationNameTextfield.text
////
////        present(genderController, animated: false, completion: nil)
//      
//    }
//    
